...
namespace Framework.ControlPanel.CommonCode.Helpers
{
    public class DateTimeHelper
    {
        ...
        /// <summary>
        /// Get Formatted Date based on culture and format
        /// </summary>
        /// <param name="dateTime"></param>
        /// <param name="cultureValue">Default Saudi Culture(ar-SA)</param>
        /// <param name="format">Default Arabic format(yyyy/MM/dd)</param>
        /// <returns></returns>
        public static string GetFormattedDateTime(DateTime dateTime, string cultureValue = ArabicSaudiCultureValue, string format = ArabicDateFormat)
        {
            return ApplyFormat(GetCultureInfo(cultureValue), dateTime, format);
        }
